...
def prepare_like_endpoint(rating: Union[str, LikeStatus]) -> str:
    if rating == LikeStatus.LIKE:
        return "like/like"
    elif rating == LikeStatus.DISLIKE:
        return "like/dislike"
    elif rating == LikeStatus.INDIFFERENT:
...
def validate_order_parameter(order: Optional[LibraryOrderType]) -> None:
